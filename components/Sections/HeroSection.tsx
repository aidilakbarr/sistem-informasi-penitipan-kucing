  ...
  return (
    <section className="relative min-h-screen bg-amber-50 overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-20 right-0 w-[600px] h-[600px] bg-amber-200/30 rounded-full blur-3xl translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-orange-200/20 rounded-full blur-3xl -translate-x-1/3" />
        {DECO_PAWS.map((p, i) => (
          <div
            key={i}
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-24 pb-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-stone-600 text-lg leading-relaxed mb-8 max-w-md">
            Kami merawat kucing kesayangan Anda layaknya anggota keluarga sendiri — dengan fasilitas
            bersih, staf berpengalaman, dan update real-time setiap hari.
          </p>
          ...
          <div className="flex gap-8">
            {STATS.map((s) => (
              <div key={s.label}>
                <div className="text-2xl font-black text-stone-900">{s.val}</div>
        ...
        <div className="relative flex justify-center">
          <div className="relative">
            <div className="w-72 h-80 bg-gradient-to-br from-amber-300 to-orange-400 rounded-[2.5rem] flex items-end justify-center overflow-hidden shadow-2xl shadow-amber-200">
              <div className="text-[180px] leading-none select-none mb-[-10px]">🐱</div>
            </div>
            ...
            <div className="absolute -top-6 -left-10 bg-white rounded-2xl shadow-lg p-3 flex items-center gap-2.5">
              ...
              <div>
                <div className="text-xs font-bold text-stone-800">Vaksin Verified</div>
                <div className="text-[10px] text-stone-500">Aman & terpercaya</div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-5 -right-8 bg-white rounded-2xl shadow-lg p-3 flex items-center gap-2.5">
              ...
              <div>
                <div className="text-xs font-bold text-stone-800">Update Harian</div>
                <div className="text-[10px] text-stone-500">Foto & video kucing</div>
              </div>
            </div>
