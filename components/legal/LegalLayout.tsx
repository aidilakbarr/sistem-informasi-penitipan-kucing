...
export function LegalLayout({ title, subtitle, lastUpdated, sections, badge }: LegalLayoutProps) {
  return (
        ...
        <main>
          ...
          <div className="bg-white rounded-3xl border border-stone-100 p-8 mb-8">
            ...
            <div className="flex items-center gap-4 text-xs text-stone-400 pt-4 border-t border-stone-100">
              <span>📅 Terakhir diperbarui: <strong className="text-stone-600">{lastUpdated}</strong></span>
              ...
              >
                <div className="flex items-start gap-4 mb-5">
                  <div className="w-8 h-8 bg-amber-100 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-xs font-black text-amber-700">{String(i + 1).padStart(2, "0")}</span>
                  </div>
                  <h2 className="text-lg font-black text-stone-900 leading-snug">{s.title}</h2>
                </div>
          ...
          <div className="mt-8 bg-amber-50 border border-amber-100 rounded-2xl p-6 text-sm text-stone-600">
            ...
            <p>
              Hubungi kami di{" "}
              <a href="mailto:hello@kucingku.id" className="text-amber-600 hover:underline font-medium">
                hello@kucingku.id
              </a>{" "}
              atau WhatsApp{" "}
              <a href="https://wa.me/6281234567890" className="text-amber-600 hover:underline font-medium">
                0812-3456-7890
              </a>
              .
            </p>
