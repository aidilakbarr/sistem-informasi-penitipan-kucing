...
export const metadata: Metadata = {
  title: "Lupa Password — KucingKu",
  description: "Reset password akun KucingKu Anda melalui verifikasi email.",
};
    ...
    <div className="min-h-screen bg-amber-50 flex">
      ...
      <aside className="hidden lg:flex lg:w-[42%] relative bg-gradient-to-br from-stone-800 to-stone-900 flex-col justify-between overflow-hidden p-12">
        ...
        <Link href="/" className="relative flex items-center gap-3 group w-fit">
          ...
          <span className="font-black text-xl text-white tracking-tight">KucingKu</span>
        </Link>
        ...
        <div className="relative">
          ...
          <h2 className="text-3xl font-black text-white leading-snug mb-4">
            Tenang, kami<br />bantu reset<br />password Anda
          </h2>
          <p className="text-stone-400 text-sm leading-relaxed max-w-xs mb-8">
            Ikuti 3 langkah mudah untuk mendapatkan kembali akses ke akun KucingKu Anda.
          </p>
          ...
          <div className="space-y-3">
            {TIPS.map(({ icon, text }) => (
              <div key={text} className="flex items-start gap-3">
                ...
                <p className="text-stone-400 text-sm leading-snug pt-1">{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative">
          <p className="text-stone-600 text-xs">
            Butuh bantuan?{" "}
            <a href="mailto:hello@kucingku.id" className="text-amber-400 hover:text-amber-300 transition-colors">
              hello@kucingku.id
            </a>
          </p>
        </div>
